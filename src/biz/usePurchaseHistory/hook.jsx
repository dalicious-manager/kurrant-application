...
const usePurchaseHistory = () => {
  const [isAllPurchaseLoading, setAllPurchaseLoading] = useAtom(
    isPurchaseLoadingAtom,
  );
  const [isMarketPurchaseLoading, setMarketPurchaseLoading] = useAtom(
    isMarketPurchaseLoadingAtom,
  );
  const [isCatorPurchaseLoading, setCatorPurchaseLoading] = useAtom(
    isCatorPurchaseLoadingAtom,
  );
  const [isMealPurchaseLoading, setMealPurchaseLoading] = useAtom(
    isMealPurchaseLoadingAtom,
  );
  const [isPurchaseDetailLoading, setPurchaseDetailLoading] = useAtom(
    isPurchaseDetailLoadingAtom,
  );
