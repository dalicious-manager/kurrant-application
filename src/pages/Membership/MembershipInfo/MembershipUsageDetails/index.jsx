                ...
                <SubscriptionBox key={index}>
                  <TextBox>
                    <Label
                      size="labelM"
                      type={
                        membership.membershipSubscriptionType === '월간구독'
                          ? 'blue'
                          : 'green'
                      }
                    ...
                    <Typography
                      text={'Body05SB'}
                      textColor={themeApp.colors.grey[2]}>
                      {withCommas(membership.discountedPrice)} 원
                    </Typography>
                  </TextBox>
                  <TextBox>
                    <Typography
                    ...
                    <Typography
                      ...
                      }>{`${membership.startDate} ~ ${membership.endDate}`}</Typography>
                  </TextBox>
                  <TextBox>
                    <Typography
                      text={'Body06R'}
                    ...
                    <Typography
                      text={'Body06R'}
                      textColor={themeApp.colors.grey[2]}>
                      {membership.membershipUsingPeriod} 개월
                    </Typography>
                  </TextBox>
                </SubscriptionBox>
              );
