    ...
    return (
        <Wrapper>
            <ScrollContiner>            
                ...
                제 1 조 목적{'\n'}
                이 약관은 달리셔스(이하 “회사“)에서 제공하는 달리셔스 서비스 및 달리셔스 에서 제공하는 제반 서비스(이하 “서비스“)에 접속과 사용자에 의해서 업로드 및 다운로드 되어 표시되는 모든 정보, 텍스트, 이미지 및 기타 자료를 이용하는 이용자(이하 “회원“)와 서비스 이용에 관한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.{'\n'}
                {'\n'}
                제 2 조 약관의 게시와 효력, 개정{'\n'}
                ...
                {'\n'}
                제 4 조 용어의 정의{'\n'}
                1. 서비스: 개인용 컴퓨터 (PC), TV, 휴대형 단말기, 전기통신설비 등 포함 각종 유무선 장치와 같이 구현되는 단말기와 상관없이 회원이 이용할 수 있는 달리셔스 및 달리셔스 관련 제반 서비스를 의미합니다. 제반 서비스에는 개발자 및 서비스 제공자가 달리셔스 Open Application Programming Interface 서비스와 이를 이용하여 개발한 API 응용 애플리케이션 또는 웹서비스도 포함됩니다.{'\n'}
                ...
                7. 유료서비스: 회사가 유료로 제공하는 각종 온라인 디지털 콘텐츠 및 제반 서비스를 의미합니다.{'\n'}
                {'\n'}
                제 5 조 이용계약의 체결{'\n'}
                1. 이용계약은 회원이 달리셔스 서비스 및 제반 서비스에서 제공하는 회원 가입 페이지에서 서비스 이용약관에 동의한 후 이용신청을 하고 신청한 내용에 대해서 회사가 승낙함으로써 체결됩니다.{'\n'}
                ...
                {'\n'}
                제 6 조 환불규정{'\n'}
                1. 결제가 완료된 상품이 등이 품절 등의 사유로 인도 또는 제공할 수 없을 때에는 3영업일 이내에 최초 결제한 방법을 이용하여 환불해드립니다. hello@dalicious.co 또는 1577-9612 로 연락주시기 바랍니다.{'\n'}
                2. ‘전자상거래 등에서의 소비자보호에 관한 법률’ 제17조에 따라 구매자는 상품을 배송 받은 날로부터 7일 이내에 반품 또는 교환을 요청할 수 있습니다.{'\n'}
                3. 제1항 및 제2항의 규정에 불구하고 재화 등의 내용이 표시광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화 등을 공급받은 날로부터 3월 이내, 그 사실을 안 날 또는 알 수 있었던 날로부터 30일 이내에 청약철회 등을 할 수 있습니다.{'\n'}
                {'\n'}
                제 7 조 청약철회 등의 효과{'\n'}
                1. 회사는 이용자로부터 재화 등을 반환 받은 경우 3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 회사는 이용자에게 재화 등의 환급을 지연한 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.{'\n'}
                ...
                3. 청약철회 등의 경우 공급받은 재화 등의 반환에 필요한 비용은 이용자가 부담합니다. 회사는 이용자에게 청약철회 등을 이유로 위약금 또는 손해배상을 청구하지 않습니다. 다만 재화 등의 내용이 표시광고 내용과 다르거나 계약내용과 다르게 이행되어 청약철회 등을 하는 경우 재 화 등의 반환에 필요한 비용은 회사가 부담합니다.{'\n'}
                4. 이용자가 재화 등을 제공받을 때 발송비를 부담한 경우에 회사는 청약철회시 그 비용을 누가 부담하는 지를 이용자가 알기 쉽도록 명확하게 표시합니다.{'\n'}
                {'\n'}
                제 8 조 교환/반품처리 불가안내{'\n'}
                ...
                5. 회원은 회사의 사전 허락 없이 회사가 정한 이용 목적과 방법에 반하여 영업/광고활동 등을 할 수 없고, 회원의 서비스 이용이 회사의 재산권, 영업권 또는 비즈니스 모델을 침해하여서는 안 됩니다.{'\n'}
                {'\n'}
                제 13 조 서비스의 제공 및 변경{'\n'}
                1. 회사는 회원에게 아래와 같은 서비스를 제공합니다.{'\n'}
                - 달리셔스 및 달리셔스 통합계정 서비스{'\n'}
                ...
                3. 회사는 회원과 별도로 서면 계약을 체결하여 달리셔스 서비스 및 제반 서비스의 브랜드 특성을 이용할 수 있는 명시적인 권리를 부여하지 아니하는 한, 회원에게 회사 또는 서비스의 상호, 상표, 서비스표, 로고, 도메인 네임 및 기타 식별력 있는 브랜드 특성을 이용할 수 있는 권리를 부여하지 않습니다.{'\n'}
                ...
                3. 회원의 관리 소홀로 인한 ID 및 비밀번호의 유출로 인하여 회원에게 서비스 이용상의 손해가 발생하거나 제3자에 의한 부정이용 등으로 회원의 의무조항을 위반한 경우 해당 ID 및 해당 도메인의 이용이 제한될 수 있습니다.{'\n'}
                4. 회사가 본 약관 제9조의 위반 행위를 조사하는 과정에서 당해 회원 ID 및 도메인이 특정 위반행위에 직접적으로 관련되어 있는 경우 등 다른 회원의 권익 보호 및 서비스의 질서유지를 위해 불가피할 경우에는 해당 ID 및 도메인의 이용을 일시적으로 정지할 수 있습니다. 이에 대해 회원은 서비스 홈페이지 또는 전자 우편 등을 통해 이의신청을 할 수 있습니다.{'\n'}
                {'\n'}
                제 17 조 게시물의 권리와 책임{'\n'}
                
                1. 회원이 서비스 내에 작성한 텍스트, 이미지, 동영상, 제14조 게시물의 권리와 책임 링크 등의 기타 정보(이하 “게시물“)에 대한 책임 및 권리는 게시물을 등록한 회원에게 있습니다.{'\n'}
                ...
                - 서비스(제3자가 운영하는 사이트 또는 미디어의 일정 영역 내에 입점하여 서비스가 제공되는 경우를 포함합니다)내에서 게시물을 사용하기 위하여 게시물의 크기를 변환하거나 단순화하는 등의 방식으로 수정하는 것- 회사에서 운영하는 다른 사이트 또는 다른 회사가 운영하는 사이트에 게시물을 복제ㆍ전송ㆍ전시하는 것- 회사의 서비스를 홍보하기 위한 목적으로 미디어, 통신사 등에게 게시물의 내용을 보도, 방영하게 하는 것. 단, 이 경우 회사는 회원의 개별 동의없이 미디어, 통신사 등에게 회원정보를 제공하지 않으며, 회원 정보를 보호하기 위해 정보의 일부를 가립니다.5. 회원이 회원탈퇴를 한 경우에는 본인 도메인에 기록된 저작물 일체는 삭제됩니다. 단, 저작물이 공동 저작을 통해 작성된 경우에는 공동 저작자의 도메인에 해당 게시물이 남을 수 있고, 제3자에 의하여 보관되거나 무단복제 등을 통하여 복제됨으로써 해당 저작물이 삭제되지 않고 재 게시된 경우에 대하여 회사는 책임을 지지 않습니다. 또한, 본 약관 및 관계 법령을 위반한 회원의 경우 다른 회원을 보호하고, 법원, 수사기관 또는 관련 기관의 요청에 따른 증거자료로 활용하기 위해 회원탈퇴 후에도 관계 법령이 허용하는 한도에서 회원의 아이디 및 회원정보를 보관할 수 있습니다.6. 회원의 게시물 또는 저작물이 회사 또는 제3자의 저작권 등 지적재산권을 침해함으로써 발생하는 민∙형사상의 책임은 전적으로 회원이 부담하여야 합니다.{'\n'}
        
                제 18 조 게시물의 관리{'\n'}
            
                1. 회원의 게시물이 다음 각 호에 해당될 경우 회사는 해당 게시물에 대해 예고 없이 임시조치 등을 취할 수 있습니다(1) 정보통신망법 및 저작권법 등 관련법에 위반되는 내용을 포함하는 경(2) 본 서비스의 운영에 지장을 초래할 우려가 되는 경우(3) 본 약관 및 기타 회사 정책, 관련법에 위반되는 경우(4) 타인 명의 또는 허위의 사용자 ID를 사용한 경우(5) 공서양속에 위반되는 경우(6) 기타 법령에 위반되거나 권리침해가 인정될 만한 사유는 경우{'\n'}
        
                2. 회원이 비공개로 설정한 게시물에 대해서는 회사를 포함한 다른 사람이 열람할 수 없습니다. 단, 법원, 수사기관이나 기타 행정기관으로부터 정보제공을 요청받은 경우나 기타 법률에 의해 요구되는 경우에는 회사를 포함한 다른 사람이 해당 게시물을 열람할 수 있습니다.{'\n'}
            
                제 19 조 서비스 이용의 중지 및 해지{'\n'}
                ...
                5. 회사는 천재지변, 전쟁, 기간통신사업자의 서비스 중지, 제3자가 제공하는 오픈ID의 인증 장애, 해결이 곤란한 기술적 결함 기타 불가항력으로 인하여 서비스를 제공할 수 없는 경우 책임이 면제됩니다.{'\n'}
