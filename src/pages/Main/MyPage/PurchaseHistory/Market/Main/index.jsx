...
const confirmPress = (setModal) =>{    
  ...
  const {getPurchaseHistory, readAbleAtom:{marketPurchase ,isMarketPurchaseLoading}} = usePurchaseHistory();
  ...
  return (
    ...
    <Container>
      <Wrapper>
        ...
        {isMarketPurchaseLoading ? <Skeleton />:
        <Wrapper>
        {marketPurchase?.data ? <ScrollViewBox>{marketPurchase?.data?.map((v,i)=>{
