...
const Pages =  ()=>{
    ...
    return(
        <Wrapper paddingTop={24}>
            ...
            {/* <ListBox title="결제 및 멤버십" onPressEvent={()=>navigation.navigate(FAQListPageName,{
                page:"membership"
            })}/> */}
