...
const Component = () => {
  return (
    ...
    <SkeletonPlaceholder.Item width={'100%'} height={6} marginVertical={24}/>
    <SkeletonPlaceholder.Item width={100} height={20}   marginLeft={24}/>
    <SkeletonPlaceholder.Item flexDirection="row" alignItems="center" justifyContent='space-between' marginHorizontal={24} marginTop={9}>
      <SkeletonPlaceholder.Item width={60} height={60} borderRadius={50} />
      <SkeletonPlaceholder.Item width={60} height={60} borderRadius={50} />
      <SkeletonPlaceholder.Item width={60} height={60} borderRadius={50} />
      <SkeletonPlaceholder.Item width={60} height={60} borderRadius={50} />
