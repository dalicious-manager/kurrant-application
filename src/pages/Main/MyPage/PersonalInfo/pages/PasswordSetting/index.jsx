...
import { Keyboard, NativeModules, Platform, ScrollView, View } from "react-native";
...
const Pages = ()=>{
    ...
    const isValidation = currantPassword && !errors.currantPassword 
    && newPassword && !errors.newPassword &&
    newPasswordCheck && !errors.newPasswordCheck;
    ...
    const getTitle = useCallback(()=>{
        ...
        setTitle(title);
    },[keyboardStatus.isKeyboardActivate, newCheckFocused, newFocused, nowFocused, title]);
          ...
          <KeyDismiss onPress={()=>Keyboard.dismiss()}>
            <KeyContainer 
              ...
              behavior={Platform.OS === "ios" ? "padding" : "height"} >              
                <TitleBox><Typography text={'Title04SB'} textColor={themeApp.colors.grey[2]}>{title}
                    </Typography></TitleBox>
                <Container>
