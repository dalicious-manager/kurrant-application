      ...
      {isConnected.map(v => {
        ...
        return (
          <SNSPiece
            key={v.social}
            onPress={() =>
              !v.isConnect ? connectSNS(v.social) : disconnectSNS(v.social)
            }>
            <SNSIdBox>
              <SocialConnectIcons
                social={v.social}
              ...
              <SNSConnectText
                text={'Body06R'}
                textColor={
                  v.email ? themeApp.colors.grey[3] : themeApp.colors.grey[7]
                }>
                {emailText()}
              </SNSConnectText>
            </SNSIdBox>
            <SNSConnectText
              text="Button10R"
              textColor={
                v.isConnect ? themeApp.colors.grey[3] : themeApp.colors.grey[5]
              }>
