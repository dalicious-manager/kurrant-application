...
const Pages = ()=>{
    ...
    (progress >= 3 &&password&& passwordChecked&&!errors.password &&!errors.passwordChecked)
        ...
        <Wrapper paddingTop={24}>
            ...
            <SafeContainer >
                <KeyDismiss onPress={()=>Keyboard.dismiss()}>
                    ...
                    <InfomationDescription>{'이메일/비밀번호가 설정되어 있지 않아요.\n이메일/비밀번호 설정시 이메일을 통해 로그인이 가능해요.'}</InfomationDescription>
                    <Container>
                        <ScrollView
                        ...
                        {progress > 2 && progress <= 3 &&<PasswordBox>
                        <RefTextInput 
                        name="password" 
                        label="비밀번호"
                        isPassword={true}
