...
const Pages = () => {
    ...
    const isValidation = email && userName && !errors.email && !errors.name && !auth.readableAtom.isCheckedAuthLoading;
            ...
            <FormProvider {...form}>
                <SafeContainer >
                    <KeyDismiss onPress={() => Keyboard.dismiss()}>
                        <InfomationText>비밀번호를 재설정하기 위해선{'\n'}회원정보 확인이 필요합니다.</InfomationText>
                        <KeyContainer >
                            <Container>
                                <RefTextInput
                                    name="name"
                                ...
                                <View>
                                    ...
                                    <CaptionBox>
                                        ...
                                        <CaptionText>
                                            회원 이름과 이메일 정보가 일치하지 않는 경우 메시지를 받을 수 없습니다.
                                        </CaptionText>
                                    </CaptionBox>
                                </View>
