...
const Component = ({point}) => {
  ...
  return (
   <Container>
    ...
    <TailBox>
      <PointNumberText text={'Body05SB'} textColor={themeApp.colors.grey[2]}>{withCommas(point||0)}</PointNumberText>
      <PointText text={'Body05R'} textColor={themeApp.colors.grey[2]}>P</PointText>
