  ...
  return (
    <Container>
      <Wrapper paddingTop={24}>
        <ScrollView>
          <GourmetTestButton>
            <Typography text="CaptionSB" textColor={themeApp.colors.blue[500]}>
              나의 미식타입 테스트{' '}
            </Typography>
            <ArrowRight />
          </GourmetTestButton>
            ...
            <LoginBox>
              <LoginIdBox>
                <AvatarBackground source={AvatarNon} resizeMode={'stretch'}>
                  {myInfo.gourmetType !== null && (
                    <Image
                      imagePath={{
                        uri: 'https://asset.kurrant.co/img/common/soup.png',
                      }}
                      scale={1.0}
                      styles={{width: 25, height: 22}}
                    />
                  )}
                </AvatarBackground>
                <Typography
          ...
          <InfomationContainer>
            ...
            <InfomationBox>
              ...
              <InfomationLabel
                ...
                textColor={themeApp.colors.grey[2]}>
                찜목록
                <InfomationCaption textColor={themeApp.colors.grey[5]}>
                  (준비중)
                </InfomationCaption>
              </InfomationLabel>
            </InfomationBox>
