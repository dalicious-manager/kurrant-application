...
import { corpApplicationSpotsAtom, corpApplicationTotalSpotAtom, isCorpMealDinnerInfoAtom, isCorpMealLunchInfoAtom, isCorpMealMorningInfoAtom, isCorporationApplicant, isCorpSendAddressAtom, isCorpSendAddressInfoAtom, isCorpSendSpotAddressInfoAtom } from "../../../../../biz/useCorporationApplication/store";
...
const Pages = () => {
    ...
    const isValidation = 
        (garbageChk && !errors.garbage) &&
        (hotStorageChk && !errors.hotStorage)
        && (settingChk && !errors.setting) 
        ...
        <Wrap>
            ...
            <ButtonWrap>
                <Button 
                    ...
                    label={'스팟 개설 신청'} 
                    onPressEvent={() => {applicationPress()}}/>
            </ButtonWrap>}
            <BottomSheet title='쓰레기 수거 서비스(선택)' description={`50인 미만 : 300원/1인 ${'\n'}50인 이상 : 15,000원/일`} modalVisible={modalVisible} setModalVisible={setModalVisible} setSelected={setSelected} selected={selected} data={garbageList}  setName={setName} setValue={garbageValue}/>
            <BottomSheet title='온장고 대여 서비스(선택)' description={'20,000원/월'} modalVisible={modalVisible2} setModalVisible={setModalVisible2} setSelected={setSelected2} selected={selected2} setName={setName2} setValue={hotStorageValue} data={hotStorageList}/>
            <BottomSheet title='식사 세팅 지원 서비스(선택)' description={`1,000,000원/월, 200명 단위 인원 증가 ${'\n'}(예. 750명, 월 4,000,000원,인력 4명)`}  modalVisible={modalVisible3} setModalVisible={setModalVisible3} setSelected={setSelected3} selected={selected3} setName={setName3} setValue={settingValue} data={settingList}/>
