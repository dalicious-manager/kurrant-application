...
import {
  ...
  isApartAddressAtom,
  isApartDongCountAtom,
  isApartFamilyCountAtom,
  isApartFullAddressAtom,
  isApartNameAtom,
  isApartSendAddressAtom,
  isApartSendAddressInfoAtom,
  isApartStartDateAtom,
          ...
          <Container>
            ...
            <View style={inputStyle}>
              <RefTextInput
                label="오픈 스팟 주소"
                name="address"
                placeholder="오픈 스팟 주소"
                defaultValue={isApartFullAddress}
                onPressIn={() =>
                  navigation.navigate(ApartmentApplicationPostcodePageName)
                }
              />
              <ArrowIcon />
            </View>
      ...
      {!show && !keyboardStatus.isKeyboardActivate && (
        <ButtonWrap>
          <Button
            ...
            onPressEvent={() => {
              navigation.navigate(ApartmentApplicationThirdPageName);
              saveAtom();
            }}
          />
        </ButtonWrap>
